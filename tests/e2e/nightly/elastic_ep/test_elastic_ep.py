...
def _scale_with_traffic(
    ...
    with ThreadPoolExecutor(max_workers=len(clients)) as executor:
        futures = [
            executor.submit(
                _traffic_loop, server, rank, ready, stop, finished, model_name, is_probe
            )
...
CONFIG_QWEN3_30B_TP2 = ElasticEPTestConfig(
    name="Qwen3-30B-3B, TP=2, Default, FC1",
...
CONFIG_QWEN3_30B_W8A8_TP2 = ElasticEPTestConfig(
    name="Qwen3-30B-3B-W8A8, TP=2, Default, FC1",
    data_parallel_size=4,
    data_parallel_size_local=4,
    tensor_parallel_size=2,
    gpu_memory_utilization=0.7,
...
CONFIG_QWEN3_30B_EAGER_TRAFFIC = ElasticEPTestConfig(
    name="Qwen3-30B-3B, Enforce Eager, Traffic Mode",
    data_parallel_size=4,
    data_parallel_size_local=4,
    tensor_parallel_size=1,
    gpu_memory_utilization=0.7,
    ...
    enforce_eager=True,
    additional_config=(
        '{"eplb_config": {"dynamic_eplb": false, "num_redundant_experts": 0}}'
    ),
    scale_sequence=ScaleSequence(
        name="tp1_scaling",
        steps=[
...
CONFIG_QWEN3_30B_DEFAULT_TRAFFIC = ElasticEPTestConfig(
    name="Qwen3-30B-3B, Default Graph, Traffic Mode",
    data_parallel_size=4,
    data_parallel_size_local=4,
    tensor_parallel_size=1,
    gpu_memory_utilization=0.7,
...
def _run_elastic_ep_test(
    config: ElasticEPTestConfig, model_name: str, traffic_mode: str | None = None
) -> None:
...
def test_elastic_ep_scaling_qwen3_30b_with_tp2() -> None:
    """Scale dp 4 -> 3 -> 2 -> 3 -> 4 (tp=2, 8 NPUs) with Default Graph, FC1"""
...
def test_elastic_ep_scaling_qwen3_30b_w8a8_with_tp2() -> None:
    """Scale dp 4 -> 3 -> 2 -> 3 -> 4 (tp=2, 8 NPUs) with W8A8, FC1"""
